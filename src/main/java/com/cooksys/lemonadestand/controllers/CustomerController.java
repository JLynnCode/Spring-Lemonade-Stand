...
@RequiredArgsConstructor			// will only include as parameters: final fields, fields with @NotNull annotation
public class CustomerController {
	...
	@PatchMapping("/{id}")
	public CustomerResponseDto updateCustomer(@PathVariable Long id, CustomerRequestDto customerRequestDto){
