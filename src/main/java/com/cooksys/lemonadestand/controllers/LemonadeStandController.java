...
public class LemonadeStandController {
		...
		@PatchMapping("/{id}")
		public LemonadeStandResponseDto updateLemonadeStand(@PathVariable Long id, LemonadeStandRequestDto lemonadeStand){
			
			return lemonadeStandService.updateLemonadeStand(id, lemonadeStand);
		}
